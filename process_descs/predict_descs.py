...
from .post_process import check_chemprop_out, min_max_normalize_atom_descs, min_max_normalize_reaction_descs, reaction_to_reactants
...
def predict_atom_descs(args, normalize=True):
    ...
    if not args.predict:
        df, scalers = min_max_normalize_atom_descs(df)
        ...
        df, _ = min_max_normalize_atom_descs(df, scalers=scalers)
