...
def parse_args(cross_val=False):
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="depth of the molecular-level feedforward network",
    )
    parser.add_argument(
        "--hidden_size_multiplier",
        type=int,
        default=20,
        help="multiplication factor for the hidden size in the molecular-level layers",
    )
    parser.add_argument(
        "--selec_epochs",
        default=100,
    ...
    parser.add_argument(
        "-d", "--depth", default=4, type=int, help="Number of steps for GNN"
    )
    parser.add_argument(
